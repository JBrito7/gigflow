...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Update new event details into the database
  if (!$error) {
    ...
    <section id="dashboard">
      <div class="container py-5 mt-5">
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label>Preço (€):</label>
            <input type="number" name="price" class="form-control" step="0.01" value="<?= $event['price'] ?>" required>
          </div>
          <button type="submit" class="btn-color">Atualizar Evento</button>
