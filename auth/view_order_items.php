...
// Fetch the purchase_items from database
$sql = "SELECT pi.id, e.title, pi.quantity, pi.price
  ...
  <main>
    <section id="edit-event">
      <div class="container py-5 mt-5">
        <h1>Bilhetes Comprados - Utilizador #<?php echo $purchase_id ?></h1>

        <?php if(count($items) === 0): ?>
        <div class="alert alert-warning">Nenhum item encontrado nesta compra.</div>
          <?php else: ?>
          ...
          <?php endif; ?>
          <a href="admin.php" class="btn-color mb-3">Voltar</a>
        </div>
      </div>
    </section>
  </main>
